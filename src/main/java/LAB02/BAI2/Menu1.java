...
//            break;
            System.out.println("nhap ten nghanh (IT/Biz): ");
            ...
            if (nghanh.equalsIgnoreCase("IT")) {
                ...
                sv = new SinhVienIT(diemJava, diemCss, diemHtml, hoten, nghanh);
                ds.add(sv);
                ...
                sv = new SinhVienBiz(diemMarketing, diemSales, hoten, nghanh);
                ds.add(sv);

            }
            System.out.println("Thuc hien nhap tiep khong:");
